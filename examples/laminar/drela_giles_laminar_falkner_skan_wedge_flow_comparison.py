...
def compare_stagnation_solution() -> None:
    ...
    labels = ["Falkner-Skan", "Drela-Giles Laminar"]
    
    #print('The initial values')
    #print(delta_d_exact[0])
    #print(delta_m_exact[0])
    #print(shape_d_exact[0])
    #print(u_e_fun(x[0]))
    #print(du_e_fun(x[0]))
    #print(DrelaGilesLaminar._mach(u_e_fun(x[0]),288.15,287,1.4))
    model = DrelaGilesLaminar(nu=nu_inf,U_e=u_e_fun,dU_edx=du_e_fun,ic = ManualCondition(delta_d=delta_d_exact[0], delta_m=delta_m_exact[0], delta_k=delta_k_exact[0]))
